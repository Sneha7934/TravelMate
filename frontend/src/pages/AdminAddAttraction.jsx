...
function AdminAddAttraction() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!formData.name.trim()) {
      alert(
        "Please enter the attraction name."
      );
    ...
    try {
      ...
      const duplicateAttraction = (attractionsResponse.data || []).some(
        (attraction) =>
          normalizeName(attraction.name || "") ===
          normalizeName(formData.name)
      );

      if (duplicateAttraction) {
        setError("An attraction with this name already exists.");
        return;
      }
      ...
      >
        ...
        <div>
          ...
          <p
            ...
            "
          >
            Add a new attraction to one of
            your TravelMate destinations.
          </p>
        ...
        >
          ...
          <div className="mt-6">
            ...
            <p
              ...
              "
            >
              Enter the image file name stored
          ...
          <div className="mt-6">
            ...
            >
              ...
              the attraction's Google Maps location
              and your tour planning features.
            </p>
